...
public:
    ...
    CFX_FloatRect		GetBoundingBox(FX_FLOAT line_width, LineCap line_cap, FX_FLOAT miter_limit) const
    {
        return m_pObject->GetBoundingBox(line_width, line_cap, miter_limit);
    }
